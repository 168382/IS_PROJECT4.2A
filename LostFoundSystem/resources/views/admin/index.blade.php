...
<div class="admin-shell">
    ...
    <aside class="admin-sidebar">
        ...
        <nav class="admin-nav">
            <a href="{{ url('/admin') }}" class="admin-nav-item {{ request()->is('admin') ? 'active' : '' }}">
                <i class="fas fa-tachometer-alt"></i> <span>Overview</span>
            </a>
            <a href="{{ url('/admin/claims') }}" class="admin-nav-item {{ request()->is('admin/claims') ? 'active' : '' }}">
                <i class="fas fa-tasks"></i> <span>Claims</span>
                @if($pendingClaims > 0)
                    <span class="sidebar-badge">{{ $pendingClaims }}</span>
                @endif
            </a>
            <a href="{{ url('/admin/items') }}" class="admin-nav-item {{ request()->is('admin/items') ? 'active' : '' }}">
                <i class="fas fa-boxes"></i> <span>All Items</span>
            </a>
            <a href="{{ url('/admin/users') }}" class="admin-nav-item {{ request()->is('admin/users') ? 'active' : '' }}">
