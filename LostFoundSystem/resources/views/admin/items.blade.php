...
<div class="admin-shell">
    <aside class="admin-sidebar">
        ...
        <nav class="admin-nav">
            ...
            <a href="{{ url('/admin/items') }}" class="admin-nav-item active"><i class="fas fa-boxes"></i> <span>All Items</span></a>
            <a href="{{ url('/admin/users') }}" class="admin-nav-item"><i class="fas fa-users-cog"></i> <span>Users</span></a>
