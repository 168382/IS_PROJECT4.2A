@extends('layouts.app')
@section('title', 'Report Found Item — Lost and Found Tracking System')
            ...
            <div class="col-lg-8">
                <div class="report-card animate-in">
                    <div class="report-header">
                        <h3><i class="fas fa-hand-holding-heart text-success me-2"></i> Report a Found Item</h3>
                        <p>Thank you for being a good citizen! Provide details so we can match this item to its owner.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ url('/report/found') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row g-3">
                            <!-- Item Name -->
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="location_found" name="location_found" placeholder="Location" value="{{ old('location_found') }}" required>
                                    <label for="location_found"><i class="fas fa-map-marker-alt me-1"></i> Where did you find it?</label>
                                </div>
                            </div>
                            <!-- Date Found -->
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="date" class="form-control" id="date_found" name="date_found" value="{{ old('date_found', date('Y-m-d')) }}" required>
                                    <label for="date_found"><i class="fas fa-calendar me-1"></i> Date Found</label>
                                </div>
                            </div>
                            <!-- Description -->
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <div id="image-preview-container" class="mt-3 text-center d-none">
                                    <div class="position-relative d-inline-block">
                                        <img id="image-preview" src="#" alt="Found Item Image Preview" class="img-fluid rounded-3 shadow-sm border" style="max-height:250px; width:100%; object-fit:cover;">
                                        <span class="badge bg-success position-absolute top-0 end-0 m-2">Preview</span>
                                    </div>
                                    <div class="mt-2">
